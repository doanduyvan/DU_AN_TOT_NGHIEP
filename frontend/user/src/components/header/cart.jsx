...
const Cart = () => {
      ...
      const menu = (
        <div className="w-96 bg-white shadow-lg rounded-lg p-4 max-w-xs min-w-[250px] sm:w-96">
          <div className="flex justify-between items-center border-b pb-2">
            ...
            {/* <NavLink to="/cart" className="text-blue-500 text-sm">See All</NavLink> */}
            <button className="text-blue-500 text-sm" onClick={handleOpen}>See All</button>
          </div>
          ...
          <div className="mt-4 border-t pt-3">
            <p className="flex justify-between font-bold text-lg"><span>Total Price:</span> <span>${subtotal.toFixed(2)}</span></p>
          </div>
  ...
  return (
    <Dropdown overlay={menu} trigger={["click"]} placement="bottomRight" arrow open={open} onOpenChange={setOpen}>
