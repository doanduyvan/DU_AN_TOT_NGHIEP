...
const urlGetComment = "customer/productdetail/get-comment/";
const urlAddComment = "customer/productdetail/add-comment";
const urlDeleteComment = "customer/productdetail/delete-comment/";
...
const CommentProduct = ({product_id}) => {
  ...
  useEffect(() => {
    const fetchComments = async () => {
      try {
        setLoading(true);
        const res = await AxiosUser.get(urlGetComment + product_id, { params:{ page: currentPage, per_page: perPage}, useToken: true, tokenNullable: true });
    ...
    fetchComments();
  }, [isLoggedIn, product_id,currentPage,perPage]);
      ...
      <div className="mt-1">
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            />
            {rating ? <span className="ml-2">{desc[rating - 1]}</span> : ""}
          </div>
        </div>
